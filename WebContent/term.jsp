...
.pic_tit {
	...
	top: 30px;
	left: 30px;
	text-shadow: 0px 0px 7px rgba(2, 2, 3, 0.925);
}
...
.pic_com {
	...
	right: 30px;
	bottom: 30px;
	text-shadow: 0px 0px 7px rgba(7, 7, 10, 0.904);
}
...
<body>
	<div class="wrap">
		...
		<div class="content">
			...
			<div class="bread">
				<div class="bread_fr">
					<a href="index.jsp" class="home">HOME</a> &gt; <span class="sel">회원 약관</span>
				</div>
			</div>
			<section class="page">
				<div class="page_wrap">
					...
					<div class="btn_fr">
						<input type="checkbox" id="ck_item1" name="ck_item"> <label for="ck_item1">약관에 동의</label><br>
						<br>
