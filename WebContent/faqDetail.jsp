...
<body>
	...
	<div class="wrap">
		...
		<div class="content">
			...
			<div class="bread">
				<div class="bread_fr">
					<a href="index.jsp" class="home">HOME</a> &gt; <span class="sel">자주하는 질문 및 답변 상세보기</span>
				</div>
			</div>
			<section class="page">
				<div class="page_wrap">
					...
					<div class="tb_fr">
						...
						<div class="btn_group">
							...
							<%
								if (sid.equals("admin")) {
							%>
							<a href='faqWrite.jsp?no=<%=no%>' class="btn primary">답변 작성</a> <a href='faqModify.jsp?no=<%=no%>' class="btn primary">답변 수정</a> <a href='faqDelete.jsp?no=<%=no%>' class="btn primary">답변 삭제</a>
							<%
								}
							%>
						</div>
