...
<body>
	...
	<div class="wrap">
		...
		<div class="content">
			...
			<div class="bread">
				<div class="bread_fr">
					<a href="index.jsp" class="home">HOME</a> &gt; <span class="sel">글목록</span>
				</div>
			</div>
			<section class="page">
				<div class="page_wrap">
						...
						<form name="frm" action="qnaModifyPro.jsp" method="post" class="frm">
							<table class="tb">
								<tbody>
									...
									<tr>
										<th>내용</th>
										<td><textarea cols="100" rows="8" name="content" id="content"><%=rs.getString("content")%></textarea></td>
									</tr>
									<tr>
										<th>작성자</th>
							...
							<div class="btn_group">
								...
								<a href="qna.jsp" class="btn primary">자주하는 질문 및 답변 목록</a>
							</div>
						</form>
					</div>
				</div>
