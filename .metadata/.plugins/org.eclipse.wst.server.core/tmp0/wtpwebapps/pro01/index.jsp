    ...
    <div class="wrap">
        ...
        <div class="content">
            ...
            <section class="page" id="page1">
                <div class="page_wrap">
                    <h2 class="page_tit">가장 신뢰받는 글로벌 디지털 거래소<br>안전하고 투명한 시스템으로 빠르고 편리한 거래환경을 제공합니다.</h2>
                    <ul class="lst">
                        <li class="left">
                            <iframe name="vdo2" id="vdo2" width="620" height="349"
                                src="https://www.youtube.com/embed/4nWx3LMaUHw" title="YouTube video player" frameborder="0"
                        ...
                        <li class="right">
                            <ul class="ico_lst">
                                <li>
                                    <a href="https://www.youtube.com/embed/4nWx3LMaUHw" target="vdo2" class="icon1">
                                        <h3 class="cate_tit">대한민국 1등 코인거래소</h3>
                                        <p class="cate_com">890만명이 선택한 거래소 업비트.</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/embed/0YTRl6RZnYo" target="vdo2" class="icon2">
                                        <h3 class="cate_tit">한 때는 코스피 거래대금 추월</h3>
                                        <p class="cate_com">불장은 다시 옵니다!!!!!</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/embed/TFjI1Ea5HoE" target="vdo2" class="icon3">
            ...
            <section class="page" id="page2">
                <div class="page_wrap">
                    <h2 class="page_tit">실시간 거래대금 Top 3<br>코인 정보</h2>
                    <ul class="pic_lst">
                        <li>
                            <a href="https://upbit.com/exchange?code=CRIX.UPBIT.KRW-XRP">
                                <img src="./pic2/xrp_info.PNG" alt="XRP_INFO"
                                    class="pic">
                                <div class="hv_box">
                        ...
                        <li>
                            <a href="">
                                <img src="./pic2/bitcoin_info.PNG" alt="BTC_INFO" class="pic">
                                <div class="hv_box">
                        ...
                        <li>
                            <a href="">
                                <img src="./pic2/orbs_info.PNG" alt="ORBS_INFO" class="pic">
                                <div class="hv_box">
