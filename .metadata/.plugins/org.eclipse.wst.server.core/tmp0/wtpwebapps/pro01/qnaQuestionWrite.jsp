			...
			<div class="frm1">
				<form name="frm" class="frm" action="qnaQusetionWritePro.jsp" method="post">
					<table class="tb">
						<tbody>
							...
							<tr>
								...
								<td><input type="text" name="author" id="author" class="in_data" value="author" readonly required><%=author %></td>
							</tr>
							<tr>
								<th><label for="sec">비밀글선택</label></th>
									<td>
										<input type="radio" name="sec" value="y">y
										<input type="radio" name="sec" value="n">n
									</td>
							</tr>
						</tbody>
					</table>
					<div class="btn_group">
						...
						<a href="qna.jsp" class="btn primary">목록으로</a>
					</div>
				</form>
			</div>
		</div>
