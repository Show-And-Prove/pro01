 ...
 * Generated at: 2022-10-27 05:46:22 UTC
...
public final class boardModify0_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/connectionClose.conf", Long.valueOf(1666770241184L));
...
return;
    ...
    try {
      ...
      out.write("\t.in_data { display:block; float:left; width:715px; line-height:27px; padding-left:6px; background-color:#fff; color:#333; }\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("    </style>\r\n");
      out.write("    <link rel=\"stylesheet\" href=\"footer.css\">\r\n");
	...
	String id = (String) session.getAttribute("id");
      ...
      out.write("                <h2 class=\"page_title\">수정</h2>\r\n");
      out.write("  \t\t\t\t<div class=\"frm1\">\r\n");
      out.write("  \t\t\t\t\t<form name=\"frm\" action=\"boardModifyPro.jsp\" method=\"post\" class=\"frm\">\r\n");
      ...
      out.write("\" class=\"in_data\" required /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>내용</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"8\" name=\"content\" id=\"content\">");
      ...
      out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn primary\">글 수정하기</button>\r\n");
