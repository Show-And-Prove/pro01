 ...
 * Generated at: 2022-10-28 03:44:43 UTC
...
public final class qnaQuestionWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	String sec = (String)session.getAttribute("sec");
      ...
      out.write("    .frm1 { padding: 24px; width: 960px; margin:50px auto; }\r\n");
      ...
      out.write("    .tb th { height: 48px; border-bottom:1px solid #fff; color:#fff; background-color:#333; \r\n");
      out.write("    width:150px; box-sizing:border-box; }\r\n");
      ...
      out.write("\t.btn_group { clear:both; width:940px; margin:20px auto; }\r\n");
      ...
      out.write("\t.btn_group .btn.primary { background-color:#333; color:#fff; }\r\n");
      out.write("\t.btn_group .btn.primary:hover { background-color:deepskyblue; }\r\n");
      out.write("\t.in_data { display:block; float:left; line-height:36px; padding-left:6px; \r\n");
	...
	String id = (String) session.getAttribute("id");
      ...
      out.write("               <span class=\"sel\">질문 작성</span>\r\n");
      out.write("           </div>\r\n");
      out.write("       </div>\r\n");
      out.write("       <section class=\"page\">\r\n");
      out.write("           <div class=\"page_wrap\">\r\n");
      out.write("               <h2 class=\"page_title\">글 쓰기</h2>\r\n");
      out.write("\t\t\t<div class=\"frm1\">\r\n");
      out.write("\t\t\t\t<form name=\"frm\" class=\"frm\" action=\"qnaQusetionWritePro.jsp\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<table class=\"tb\">\r\n");
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"title\">제목</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"title\" id=\"title\" placeholder=\"제목 입력\" class=\"in_data\" required></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"content\">질문 내용</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"6\" name=\"content\" id=\"content\" class=\"in_data2\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"content2\">답변 내용</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"6\" name=\"content2\" id=\"content2\" class=\"in_data2\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"author\">작성자</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"author\" id=\"author\" class=\"in_data\" value=\"author\" readonly required>");
      out.print(author );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"sec\">비밀글선택</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"sec\" value=\"y\">y\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"sec\" value=\"n\">n\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t<div class=\"btn_group\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn primary\">글 쓰기</button>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"qna.jsp\" class=\"btn primary\">목록으로</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
