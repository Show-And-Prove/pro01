 ...
 * Generated at: 2022-10-27 09:26:31 UTC
...
return;
	...
	int parno = (int) session.getAttribute("parno");
      ...
      out.write("\t.in_data { display:block; float:left; width:723px; line-height:36px; padding-left:6px; background-color:#fff; color:#333;}\r\n");
	...
	String id = (String) session.getAttribute("id");
      ...
      out.write("                <span class=\"sel\">답변 작성</span>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <section class=\"page\">\r\n");
      out.write("            <div class=\"page_wrap\">\r\n");
      out.write("                <h2 class=\"page_title\">답변 작성</h2>\r\n");
      out.write("  \t\t\t\t<div class=\"frm1\">\r\n");
      out.write("  \t\t\t\t\t<form name=\"frm\" action=\"faqAnswerWritePro.jsp\" method=\"post\" class=\"frm\">\r\n");
      out.write("\t  \t\t\t\t\t<table class=\"tb\">\r\n");
      out.write("\t  \t\t\t\t\t\t<tbody>             \r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>제목</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"title\" id=\"title\" class=\"in_data\" required /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>내용</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"8\" name=\"content\" id=\"content\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>답변 할 질문 번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"number\" name=\"parno\" id=\"parno\" class=\"in_data\" required /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>작성자</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn primary\">글 작성</button>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"faq.jsp\" class=\"btn primary\">게시판 목록</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
