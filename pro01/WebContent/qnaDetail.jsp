  				...
  				<div class="tb_fr">
					...
					<div class="btn_group">
						...
						<%
							if(sid.equals("admin")) {
						%>
						<a href='qnaWrite.jsp?no=<%=no %>' class="btn primary">답변 작성</a>
						<a href='qnaModify.jsp?no=<%=no %>' class="btn primary">답변 수정</a>
						<a href='qnaDelete.jsp?no=<%=no %>' class="btn primary">답변 삭제</a>
						<% } %>
					</div>
				</div>
			</div>
